// src/pages/authentication/Register/index.tsx
import {
	Button,
	Card,
	CardBody,
			...
			<Card>
				<CardBody className="p-0 auth-header-box">
					<div className="text-center p-3">
						...
						<h4 className="mt-3 mb-1 fw-semibold text-white font-18">
							Let's Get Started MercBot
						</h4>
						<p className="text-muted  mb-0">Sign in to continue to MercBot.</p>
					</div>
				</CardBody>
				...
				<CardBody className="bg-light-alt text-center">
					<span className="text-muted d-none d-sm-inline-block">
						MercBot © <script>{new Date().getFullYear()}</script>
					</span>
				</CardBody>
			</Card>
		</AuthLayout>
